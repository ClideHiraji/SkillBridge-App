          ...
          >
            <button className="py-2.5 rounded-xl border border-gray-200 text-sm text-gray-600 font-medium flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors">
              ...
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="11" stroke="#E8E8E8" strokeWidth="0.5"/>
                <path d="M12 5c3.866 0 7 3.134 7 7h-3.5c0-1.93-1.57-3.5-3.5-3.5S8.5 10.07 8.5 12h-3.5c0-3.866 3.134-7 7-7z" fill="#4285F4"/>
                <path d="M12 5c-3.866 0-7 3.134-7 7h3.5c0-1.93 1.57-3.5 3.5-3.5s3.5 1.57 3.5 3.5h3.5c0-3.866-3.134-7-7-7z" fill="#EA4335"/>
              </svg>
              Google
            </button>
            <button className="py-2.5 rounded-xl border border-gray-200 text-sm text-gray-600 font-medium flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors">
